...
class JsonPrettyPrint
{
    ...
    /**
     * @var Defines the color used for text values in the JSON string..
     */
    public $text_value_color;
    /**
     * @var Defines the color used for number values in the JSON string..
     */
    public $number_value_color;
    /**
     * @var Defines the color used for boolean values in the JSON string.
     */
     ...
     * @return The symbol in the pretty JSON format.
     */
     ...
     * @return The text value in the pretty JSON format.
     */
     ...
     * @return The number value in the pretty JSON format.
     */
     ...
     * @return The boolean value in the pretty JSON format.
     */
     ...
     * @return The property name in the pretty JSON format.
     */
